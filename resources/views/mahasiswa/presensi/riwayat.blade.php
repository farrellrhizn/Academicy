						...
						<div class="card-box pd-20">
							...
							<div class="progress mb-20" style="height: 25px;">
								<div class="progress-bar 
									...
									role="progressbar" style="width: {{ $statistik['persentase_kehadiran'] }}%"
									aria-valuenow="{{ $statistik['persentase_kehadiran'] }}" aria-valuemin="0"
									aria-valuemax="100">
									{{ $statistik['persentase_kehadiran'] }}%
								</div>
							</div>
							@if($statistik['persentase_kehadiran'] < 75)
								...
								Persentase kehadiran Anda masih di bawah 75%. Pastikan untuk hadir di pertemuan
								selanjutnya agar memenuhi syarat mengikuti ujian.
						</div>
						@else
					...
					<div class="card-box pd-20">
						<div class="clearfix mb-20">
							<div class="pull-left">
								...
								<p class="mb-30">Mata Kuliah:
									<strong>{{ $riwayatPresensi->first()->matakuliah->Nama_mk ?? '' }}</strong>
								</p>
							</div>
						</div>
				...
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-30">
					<div class="card-box pd-20 text-center">
						...
						<div class="alert alert-info" role="alert">
							<i class="fa fa-info-circle"></i> Data presensi akan muncul setelah dosen melakukan
			...
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-30">
					<div class="card-box pd-20 text-center">
						...
						<p class="text-muted mb-20">Silakan pilih mata kuliah untuk melihat riwayat presensi Anda
						</p>
						@if($matakuliahDiambil->count() == 0)
						<div class="alert alert-warning" role="alert">
							<i class="fa fa-warning"></i> Anda belum mengambil mata kuliah pada semester ini.
							<a href="{{ route('mahasiswa.krs.index') }}" class="alert-link">Silakan ambil mata
								kuliah terlebih dahulu.</a>
						</div>
						@endif
					</div>
				</div>

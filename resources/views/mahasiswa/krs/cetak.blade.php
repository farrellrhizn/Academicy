...
<head>
	...
	<style>
		@media print {
			...
			.left-side-bar,
			.mobile-menu-overlay,
			.main-container .pd-ltr-20 .footer-wrap {
				display: none !important;
			}
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-30">
						<div class="card-box pd-20">
							...
							<div class="text-center mb-4">
								...
								<p style="margin: 5px 0;">SEMESTER {{ $mahasiswa->Semester }} TAHUN AKADEMIK
									{{ date('Y') }}/{{ date('Y') + 1 }}
								</p>
							</div>
									...
									<tfoot>
										<tr style="background-color: #f8f9fa;">
											...
											<td style="text-align: center; font-weight: bold;">
												{{ $krsData->sum(fn($krs) => $krs->matakuliah->sks) }}
											</td>
											<td colspan="3"></td>
										</tr>
									</tfoot>
							...
							<div style="margin-top: 30px;">
								...
								<ol style="font-size: 12px; line-height: 1.6;">
									<li>KRS ini berlaku untuk semester {{ $mahasiswa->Semester }} tahun akademik
										{{ date('Y') }}/{{ date('Y') + 1 }}
									</li>
									<li>Perubahan KRS dapat dilakukan sesuai dengan jadwal yang ditetapkan oleh akademik
									</li>
									...
									<li>Mahasiswa yang tidak hadir tanpa keterangan lebih dari 25% dari total pertemuan
										akan mendapat nilai E</li>
								</ol>
							</div>

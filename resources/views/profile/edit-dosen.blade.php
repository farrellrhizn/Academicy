                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-12">
                                        <div class="profile-overview">
                                            <h5 class="text-blue">{{ $dosen->Nama }}</h5>
                                            <p class="text-muted mb-1"><i class="icon-copy bi bi-card-text"></i> NIP: {{ $dosen->NIP }}</p>
                                            <p class="text-muted mb-1"><i class="icon-copy bi bi-phone"></i> No. HP: {{ $dosen->Nohp ?: 'Belum diisi' }}</p>
                                            <p class="text-muted"><i class="icon-copy bi bi-geo-alt"></i> {{ $dosen->Alamat ?: 'Alamat belum diisi' }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('dosen.profile.update') }}" enctype="multipart/form-data" id="profileForm">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="NIP"><i class="icon-copy bi bi-card-text"></i> NIP <span class="text-danger">*</span></label>
                                                <input class="form-control" type="text" value="{{ $dosen->NIP }}" readonly style="background-color: #f8f9fa;" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="Nohp"><i class="icon-copy bi bi-phone"></i> No. HP <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <a href="{{ route('dosen.dashboard') }}" class="btn btn-secondary btn-lg ml-2">

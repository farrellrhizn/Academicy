                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" name="Nama" value="{{ old('Nama', $dosen->Nama) }}" required />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="Alamat">Alamat</label>
                                                            <textarea class="form-control" name="Alamat" rows="3" required>{{ old('Alamat', $dosen->Alamat) }}</textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="Nohp">No. HP</label>
                                                            <input class="form-control" type="text" name="Nohp" value="{{ old('Nohp', $dosen->Nohp) }}" required />
                                                        </div>
                                                    </div>
                                                </div>

				...
				<div class="row pb-10">
						...
						<div class="card-box height-100-p widget-style3">
							<div class="d-flex flex-wrap">
								...
								<div class="widget-icon">
									<div class="icon" style="background-color: #1b00ff;"><i class="icon-copy bi bi-book"
					...
					<div class="col-xl-4 col-lg-4 col-md-6 mb-20">
						<div class="card-box height-100-p widget-style3">
							<div class="d-flex flex-wrap">
								...
								<div class="widget-icon">
									<div class="icon" style="background-color: #00d4aa;"><i
											class="icon-copy bi bi-stack" aria-hidden="true"></i></div>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-4 col-lg-4 col-md-6 mb-20">
						<div class="card-box height-100-p widget-style3">
							<div class="d-flex flex-wrap">
								<div class="widget-data">
									<div class="weight-700 font-24 text-dark">{{ $matakuliahPerSemester->count() }}
									</div>
									<div class="font-14 text-secondary weight-500">Semester Aktif</div>
								</div>
								<div class="widget-icon">
									<div class="icon" style="background-color: #ffb64d;"><i
											class="icon-copy bi bi-calendar3" aria-hidden="true"></i></div>
								</div>
							</div>
						</div>
					</div>
								...
								@empty
									<tr>
										<td colspan="5" class="text-center">
											<div class="pd-20">
												<img src="../../bootstrap/vendors/images/calendar-empty-state.svg" alt=""
											...
											<ul>
												<li class="d-flex align-items-center justify-content-between">
													<div class="name-avatar d-flex align-items-center pr-2">
														...
														<div class="txt">
															<span class="badge badge-pill badge-sm" data-bgcolor="#e7f5ff"
																data-color="#1c7cd6">{{ $mk->Kode_mk }}</span>
